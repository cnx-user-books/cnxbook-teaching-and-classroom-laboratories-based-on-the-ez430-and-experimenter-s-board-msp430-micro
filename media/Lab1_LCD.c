/**************************************************************************/
/*                   Lab 4 - LCD message presentation                     */
/*                                                                        */
/*                                                                        */
/*                                                                        */
/* MSP430 Teaching ROM                                                    */
...
/*           MSP430FG4618 device present a message on the LCD             */
/*           Basic Timer 1                                                */
/*                                                                        */
/* Instructions:                                                          */
/* The Timer_A together with the TACCR0 unit is used to generate          */
/*  an interrupt each second.                                             */
/*                                                                        */
/* The LED1 and LED2 are switched at each Timer_A interrupt.              */
/*                                                                        */
/* The button SW1 is used to change the value of voltage generated by     */
/*  the charge pump.                                                      */
/*                                                                        */
/* The button SW2 is used to change the LCD frequency.                    */
/*                                                                        */
/*  Complete the code below:                                              */
/*   - Configure P.5 as special function                                  */
/*   - Configure P.2 as digital output                                    */
/*   - Configure LCD_A                                                    */
/*   - Configure Timer_A                                                  */
/*                                                                        */
/*                                                                        */
